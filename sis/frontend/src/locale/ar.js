...
export const AR = {
  ...
  Language: 'اللغة',
  'Choose interface language': 'اختر لغة الواجهة',
  ...
  'On touch screens, drag a subject or lesson, or tap it and then tap its destination.': 'على شاشة اللمس، اسحب المادة أو الحصة، أو اضغط عليها ثم اضغط على مكانها الجديد.',
  'Weekly timetable': 'الجدول الأسبوعي',
  'Timetable days': 'أيام الجدول',
  'Previous day': 'اليوم السابق',
  'Next day': 'اليوم التالي',
  'Day {0} of {1}': 'اليوم {0} من {1}',
  'Period': 'الحصة',
  'Drop subject here': 'ضع المادة هنا',
  'Move lesson': 'نقل الحصة',
  'Place in {0}, {1}': 'وضعها في {0}، {1}',
  ...
  'Copying...': 'جارٍ النسخ…',
  'Break': 'فسحة',
  'Day layout': 'تنظيم اليوم الدراسي',
  'Choose the break period once. It is applied to every class in this school.': 'اختر حصة الفسحة مرة واحدة، وستُطبَّق على جميع فصول المدرسة.',
  'Choose the break period once. It is applied to every class in this school; lessons move with it automatically.': 'اختر حصة الفسحة مرة واحدة؛ ستُطبَّق على جميع فصول المدرسة وتتحرك الحصص معها تلقائيًا.',
  'Choose the break period once. It applies only to this grade’s classes; lessons move with it automatically.': 'اختر حصة الفسحة مرة واحدة؛ ستُطبَّق على فصول هذا الصف الدراسي فقط وتتحرك الحصص معها تلقائيًا.',
  'Break period': 'حصة الفسحة',
  'No break': 'لا توجد فسحة',
  'Save day layout': 'حفظ تنظيم اليوم',
  'Periods per day': 'عدد الحصص في اليوم',
  'Reducing the number deletes lessons in the removed periods.': 'تقليل العدد يحذف الحصص الموجودة في الحصص التي سيتم حذفها.',
  'Enter a number from 1 to 20.': 'أدخل عددًا من 1 إلى 20.',
  'Day starts at': 'بداية اليوم الدراسي',
  'Day ends at': 'نهاية اليوم الدراسي',
  'Enter both day times, with the end after the start.': 'أدخل وقت البداية والنهاية، ويجب أن تكون النهاية بعد البداية.',
  'Times are divided equally across the day.': 'يتم توزيع أوقات الحصص بالتساوي خلال اليوم.',
  'Break duration (minutes)': 'مدة الفسحة (بالدقائق)',
  'Enter a break duration from 0 to 180 minutes.': 'أدخل مدة للفسحة من 0 إلى 180 دقيقة.',
  'The day is too short for this number of periods and break duration.': 'مدة اليوم لا تكفي لعدد الحصص ومدة الفسحة المحددين.',
  'Could not save the timetable settings.': 'تعذر حفظ إعدادات الجدول. حاول مرة أخرى.',
  ...
  '{0} child(ren) as of {1}': '{0} طالب/طالبة حتى {1}',
  '{0} years': '{0} سنة',
  '{0} years old today.': 'العمر اليوم {0} سنة.',
  'Read from her date of birth, never stored beside it.': 'محسوب من تاريخ الميلاد ولا يُخزَّن بشكل منفصل.',
  'not on file': 'غير مسجل',
  '{0} present, {1} late.': '{0} حاضر، و{1} متأخر.',
  '{0} absent, {1} excused.': '{0} غائب، و{1} غائب بعذر.',
  '{0} may read the student record.': 'يمكن لعدد {0} الاطلاع على سجل الطالب.',
  'Student number {0}.': 'رقم الطالب {0}.',
  'Marked': 'الحالة المسجلة',
  '{0} to {1}': 'من {0} إلى {1}',
  ...
  'Messages': 'الرسائل',
  'Chats': 'الدردشات',
  'Staff messages': 'محادثات هيئة المدرسة',
  'Staff chats': 'دردشات هيئة المدرسة',
  'Your school groups are updated automatically.': 'يتم تحديث مجموعات المدرسة تلقائيًا حسب مهامك الحالية.',
  'Search staff': 'البحث في هيئة المدرسة',
  'Search for a staff member': 'ابحث عن مدرس أو موظف',
  'No staff found': 'لم يتم العثور على أحد',
  'Mute notifications': 'كتم الإشعارات',
  'Unmute notifications': 'إلغاء كتم الإشعارات',
  'Notifications muted': 'الإشعارات مكتومة',
  'For 8 hours': 'لمدة 8 ساعات',
  'For one week': 'لمدة أسبوع',
  'Always': 'دائمًا',
  'Conversations': 'المحادثات',
  'Loading conversations…': 'جارٍ تحميل المحادثات…',
  'No conversations yet': 'لا توجد محادثات بعد',
  'Whole school': 'المدرسة كلها',
  'School leadership': 'إدارة المدرسة ومشرفو الصفوف',
  'Grade staff': 'هيئة الصف',
  'Class teachers': 'مدرسو الفصل',
  'Private chat': 'محادثة خاصة',
  'All': 'الكل',
  'Private': 'خاص',
  'Filter conversations': 'تصفية المحادثات',
  'All grades': 'كل الصفوف',
  'No conversations match these filters': 'لا توجد محادثات مطابقة لهذه التصفية',
  'Group': 'مجموعة',
  '{0} unread messages': '{0} رسائل غير مقروءة',
  'Back to conversations': 'العودة إلى المحادثات',
  'Loading messages…': 'جارٍ تحميل الرسائل…',
  'Loading…': 'جارٍ التحميل…',
  'Load earlier messages': 'تحميل الرسائل السابقة',
  'Start the conversation': 'ابدأ المحادثة',
  'Messages sent here are visible only to this conversation’s current members.': 'الرسائل هنا تظهر فقط للأعضاء الحاليين في هذه المحادثة.',
  'Message': 'الرسالة',
  'Write a message': 'اكتب رسالة',
  'Send message': 'إرسال الرسالة',
  'Delete this message?': 'حذف هذه الرسالة؟',
  'Delete message': 'حذف الرسالة',
  'Message deleted': 'رسالة محذوفة',
  'Deleted message': 'رسالة محذوفة',
  'This message was deleted': 'تم حذف هذه الرسالة',
  'Everyone else will see that a message was deleted. Its original content is retained for administrative review.': 'سيظهر للآخرين أن الرسالة حُذفت، مع الاحتفاظ بمحتواها الأصلي للمراجعة الإدارية.',
  'edited': 'معدلة',
  'Edit message': 'تعديل الرسالة',
  'Editing message': 'تعديل الرسالة',
  'Cancel editing': 'إلغاء التعديل',
  'Show original': 'عرض النص الأصلي',
  'Message actions': 'خيارات الرسالة',
  'Copy text': 'نسخ النص',
  'This conversation is read-only for your account.': 'هذه المحادثة متاحة للقراءة فقط لهذا الحساب.',
  'Your staff conversations': 'محادثات هيئة المدرسة',
  'Choose a group or search for a colleague to begin.': 'اختر مجموعة أو ابحث عن زميل لبدء المحادثة.',
  'Attach files': 'إرفاق ملفات أو صور',
  'Record voice message': 'تسجيل رسالة صوتية',
  'Recording voice message': 'جارٍ تسجيل رسالة صوتية',
  'Recording paused': 'التسجيل متوقف مؤقتًا',
  'Pause recording': 'إيقاف التسجيل مؤقتًا',
  'Resume recording': 'استكمال التسجيل',
  'Delete recording': 'حذف التسجيل',
  'Send recording': 'إرسال التسجيل',
  'One minute reached': 'تم الوصول إلى دقيقة واحدة',
  'Allow microphone access to record a voice message.': 'اسمح بالوصول إلى الميكروفون لتسجيل رسالة صوتية.',
  'Sent': 'تم الإرسال',
  '{0} read, {1} delivered, {2} total': 'قرأها {0}، وصلت إلى {1}، الإجمالي {2}',
  'Message info': 'معلومات الرسالة',
  'Read by': 'قرأها',
  'Delivered to': 'وصلت إلى',
  ...
  'Voice recording could not be paused. Try recording again.': 'تعذر إيقاف التسجيل مؤقتًا. حاول تسجيله من جديد.',
  'Play voice message': 'تشغيل الرسالة الصوتية',
  'Pause voice message': 'إيقاف الرسالة الصوتية مؤقتًا',
  'Seek voice message': 'التنقل داخل الرسالة الصوتية',
  'Playback speed {0}': 'سرعة التشغيل {0}',
  'Attachment': 'مرفق',
  'Grade groups': 'مجموعات الصفوف الدراسية',
  'Class groups': 'مجموعات الفصول',
  'Filter by grade': 'تصفية حسب الصف الدراسي',
  'All grade levels': 'كل الصفوف الدراسية',
  'Preview unavailable': 'المعاينة غير متاحة',
  'The file could not be opened. You can still download it.': 'تعذّر فتح الملف، ويمكنك تنزيله بدلًا من ذلك.',
  'This file type cannot be previewed in the browser. You can download it to open it.': 'لا يمكن معاينة هذا النوع من الملفات داخل المتصفح، ويمكنك تنزيله لفتحه.',
  'Online': 'متصل الآن',
  'Offline': 'غير متصل',
  '{0} is typing…': '{0} يكتب الآن…',
  '{0} people are typing…': '{0} أشخاص يكتبون الآن…',
  'Academics': 'الأكاديميا والتدريس',
  'Students': 'شؤون الطلاب',
  'School & Staff': 'إدارة المدرسة والكادر',
  'All Screens': 'جميع الشاشات',
  'Screen categories': 'فئات الشاشات',
  'Menu': 'القائمة',
  'Staff Messages': 'رسائل ومحادثات الكادر',
  'Staff Chats': 'دردشات هيئة المدرسة',
  'Fullscreen': 'ملء الشاشة',
  'Exit fullscreen': 'إنهاء ملء الشاشة',
  'Open chat': 'فتح المحادثات',
  'Close chat': 'إغلاق المحادثات',
  'Close menu': 'إغلاق القائمة',
  'Navigation': 'التنقل',
  'Student promotion': 'ترحيل الطلاب',
  'Move the whole register into the next academic year with a review before anything is written.': 'انقل كشف القيد بالكامل إلى العام الدراسي التالي بعد مراجعته وقبل حفظ أي تغيير.',
  '1. Choose academic years': '١. اختر العامين الدراسيين',
  'Create the target year and its classes before starting.': 'أنشئ العام الجديد وفصوله قبل بدء الترحيل.',
  'Ending academic year': 'العام الدراسي المنتهي',
  'New academic year': 'العام الدراسي الجديد',
  'Preview': 'معاينة',
  '2. Review every student': '٢. راجع كل طالب',
  'Change any suggestion before applying the promotion.': 'يمكنك تغيير اقتراح أي طالب قبل تنفيذ الترحيل.',
  'Promote to next grade': 'ناجح — ترحيل للصف التالي',
  'Repeat the same grade': 'إعادة السنة في نفس الصف',
  'Graduate': 'تخرّج',
  'Exclude from this run': 'استبعاد من هذه العملية',
  'Current class': 'الفصل الحالي',
  'Decision': 'القرار',
  'Target class': 'الفصل الجديد',
  'Make the new year current after promotion': 'اجعل العام الجديد هو العام الحالي بعد الترحيل',
  'Apply promotion': 'تنفيذ الترحيل',
  'Confirm student promotion': 'تأكيد ترحيل الطلاب',
  'This closes the old placements and opens the selected placements in the target year. Previous marks and attendance remain unchanged.': 'سيتم إغلاق القيد القديم وفتح القيد المحدد في العام الجديد، مع الاحتفاظ بالدرجات والحضور السابقين دون تغيير.',
  '{0} student(s) will be processed.': 'سيتم تنفيذ العملية على {0} طالب.',
  'Student promotion completed.': 'تم ترحيل الطلاب بنجاح.',
  'No students to promote': 'لا يوجد طلاب للترحيل',
  'No placement covered the last day of the selected year.': 'لا يوجد قيد طلاب يغطي آخر يوم في العام المحدد.',
  'Grades academic year': 'السنة الدراسية للدرجات',
  'Choose the year the marks belong to.': 'اختر السنة التي تخصها الدرجات.',
  'School term': 'الفصل الدراسي',
  'Choose first or second term before selecting the file.': 'اختر الفصل الدراسي الأول أو الثاني قبل تحديد الملف.',
  'Upload end-of-term marks file': 'رفع ملف درجات نهاية الترم',
  'One row per student and subject. Use percentage, or points with max_points.': 'صف واحد لكل طالب ومادة. استخدم النسبة المئوية أو الدرجة مع الدرجة النهائية.',
  'Choose the academic year and term first.': 'اختر السنة الدراسية والفصل الدراسي أولًا.',
  'Grade for uploaded marks': 'الصف الدراسي للدرجات',
  'Only students enrolled in this grade will be accepted.': 'لن تُقبل إلا درجات الطلاب المقيدين في هذا الصف.',
  'Choose the academic year, grade and term first.': 'اختر السنة الدراسية والصف والفصل الدراسي أولًا.',
  'Set every feature permission independently. Changes affect every user who has this role.': 'حدد صلاحية كل ميزة بشكل مستقل. تسري التغييرات على كل مستخدم يحمل هذا الدور.',
  '{0} permissions selected.': 'تم تحديد {0} صلاحية.',
  '{0} of {1} enabled': '{0} من {1} مفعلة',
  'Allow group': 'تفعيل المجموعة',
  'Clear group': 'إلغاء المجموعة',
  'Permissions saved successfully.': 'تم حفظ الصلاحيات بنجاح.',
  'System administration': 'إدارة النظام',
  'Schools': 'المدارس',
  'Accounts and roles': 'الحسابات والأدوار',
  'Academic structure': 'الهيكل الدراسي',
  'Students and guardians': 'الطلاب وأولياء الأمور',
  'Teachers and assignments': 'المعلمون والتكليفات',
  'Attendance and grades': 'الحضور والدرجات',
  'Communication': 'التواصل',
  'Manage system settings': 'إدارة إعدادات النظام',
  'Change system status': 'تغيير حالة النظام',
  'View audit log': 'عرض سجل التدقيق',
  'View schools': 'عرض المدارس',
  'Manage schools': 'إدارة المدارس',
  'View staff accounts': 'عرض حسابات العاملين',
  'Manage staff accounts': 'إدارة حسابات العاملين',
  'Assign roles and scopes': 'تعيين الأدوار ونطاقاتها',
  'View academic structure': 'عرض الهيكل الدراسي',
  'Manage years, grades, classes and subjects': 'إدارة السنوات والصفوف والفصول والمواد',
  'View timetables': 'عرض الجداول الدراسية',
  'Create and edit timetables': 'إنشاء الجداول الدراسية وتعديلها',
  'View student records': 'عرض سجلات الطلاب',
  'Create students and initial enrolment': 'إنشاء الطلاب وقيدهم الأول',
  'Edit, transfer and promote students': 'تعديل الطلاب ونقلهم وترحيلهم',
  'View guardians': 'عرض أولياء الأمور',
  'Manage guardians': 'إدارة أولياء الأمور',
  'View student documents': 'عرض مستندات الطلاب',
  'Manage student documents': 'إدارة مستندات الطلاب',
  'View teachers': 'عرض المعلمين',
  'Manage teacher records': 'إدارة سجلات المعلمين',
  'Assign subjects to teachers': 'إسناد المواد إلى المعلمين',
  'Assign classes to teachers': 'إسناد الفصول إلى المعلمين',
  'View staff attendance': 'عرض حضور العاملين',
  'Record staff attendance': 'تسجيل حضور العاملين',
  'View student attendance': 'عرض حضور الطلاب',
  'Record student attendance': 'تسجيل حضور الطلاب',
  'View grades': 'عرض الدرجات',
  'Record and edit grades': 'تسجيل الدرجات وتعديلها',
  'View reports': 'عرض التقارير',
  'Upload and commit import files': 'رفع ملفات الاستيراد واعتمادها',
  'Read staff chats': 'قراءة محادثات العاملين',
  'Send and edit staff messages': 'إرسال رسائل العاملين وتعديلها',
};
