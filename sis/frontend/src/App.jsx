...
const NAV = [
  ...
  { name: 'roles', label: 'Staff roles', icon: 'roles', roles: ['admin', 'school_owner', 'school_manager'] },
  { name: 'auditLog', label: 'Audit Log', icon: 'roles', roles: ['admin'] },
  { name: 'teacherSetup', label: 'Create teacher', icon: 'teacher', roles: ['admin', 'school_manager'] },
  { name: 'teachingStaff', label: 'Teaching staff', icon: 'staff', roles: ['school_manager', 'school_owner'] },
  { name: 'gradeAssignments', label: 'Class assignments', icon: 'classAssign', roles: ['admin', 'school_manager', 'floor_supervisor'] },
