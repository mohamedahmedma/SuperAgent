...
Run:
    .venv/Scripts/python.exe tests/evals/retrieval_eval.py
    .venv/Scripts/python.exe tests/evals/retrieval_eval.py --rerank
    .venv/Scripts/python.exe tests/evals/retrieval_eval.py --top-k 8 --pool 30
