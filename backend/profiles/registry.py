...
ENV_OVERRIDES: Dict[str, str] = {
    ...
    "RERANK_LOCAL_ENABLED": "retrieval.rerank_local_enabled",
    "RERANK_LOCAL_MODEL": "retrieval.rerank_local_model",
    "RERANK_LOCAL_DEVICE": "retrieval.rerank_local_device",
    "RERANK_LOCAL_BATCH_SIZE": "retrieval.rerank_local_batch_size",
    "RERANK_LOCAL_TOP_N": "retrieval.rerank_local_top_n",
    "QUERY_TRANSLATION_ENABLED": "retrieval.query_translation_enabled",
    "QUERY_TRANSLATION_LANGUAGE": "retrieval.query_translation_language",
